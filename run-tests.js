...
function showUsage() {
  const lines = [
    ...
    '  --spec, -f            Specific spec file(s) or glob(s) to run (repeat or pass multiple)',
    ...
    '  --accessibility, -a   Run only accessibility specs',
    '  --full, -u            Shortcut for running all groups',
    '  --viewport, -V        Override responsive viewport targets',
    ...
    '  --a11y-tags, -t       Override WCAG tagging scope (e.g. wcag)',
    '  --a11y-sample, -n     Limit responsive accessibility sample size',
